...
(function (global, exports) {
    ...
    if ($ === $d) {
        ...
        $b = function (e, fn) { e.attachEvente?e.attachEvent(ke, fn):e.addEventListener(ke, fn, false); };
        $u = function (e, fn) { e.detachEvent?e.detachEvent(ke, fn):e.removeEventListener(ke, fn, false); };
